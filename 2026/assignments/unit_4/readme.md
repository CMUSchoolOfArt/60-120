...
* **Create** a Discord post in the channel with your name. For example, a student named "Chris" would document their project in the Discord channel, `#4-chris`. We will use these channels to provide written feedback for your projects during our critique.
