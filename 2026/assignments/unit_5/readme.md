...
* *NEW* — In addition to the above, **copy** (reproduce) the "Clown Nose" patch below and, in the `5-4-mediapipe-tutorials` channel, include a screenshot of you with your clown nose as well. Here are some details about this:
  ...
  * The nose position data is used to control the translation of a red `circle` TOP. 
