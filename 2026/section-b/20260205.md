...
* Hello! I'm [Golan Levin, professor of art at CMU](https://art.cmu.edu/people/golan-levin/).
* [Lectures](#presentations-in-class)
* [Upcoming Assignments](#upcoming-assignments)
* [Some Helpful Videos](#some-helpful-videos)
...
* What is software? 
	...
	* What are some distinctive properties of art/experience on a computer?
* [Introduction to Creative Coding / Pep Talk](../../lectures/creative_code/readme.md)
* [Hello p5.js](https://hello.p5js.org/) (interactive video, 4m)
* [Day One Tutorial: Shapes and Colors](https://openprocessing.org/sketch/2863677#page-1)
* Demonstration: how to make and submit a sketch
* *(Time Permitting) [Tutorial on Variables](https://openprocessing.org/sketch/2531328#page-1)*

--- 

### Upcoming Assignments:

**DUE TUESDAY 2/10** (approximately 3 hours of work total): 

* [2.1. Orientation](../assignments/unit_2/readme.md#21-orientation) *(15m; Due 2/10)*
* [2.2. Looking Outwards: Generative Art](../assignments/unit_2/readme.md#22-looking-outwards-generative-art) *(30m; Due 2/10)*
* [2.3. Reading-Response: Artist Narratives](../assignments/unit_2/readme.md#23-reading-response-artist-narratives) *(30m; Due 2/10)*
* [2.4. Reading-Response: Effective Complexity and The Oatmeal Problem](../assignments/unit_2/readme.md#24-reading-response-effective-complexity-and-the-oatmeal-problem) *(45m; Due 2/10)*
* [2.5. Warmup Exercise: Ten Shapes, One Rule](../assignments/unit_2/readme.md#25-warmup-exercise-ten-shapes-one-rule) *(45m; Due 2/10 9)*

**Due later:**

* [2.6. Face Generator](../assignments/unit_2/readme.md#26-face-generator) *(2.5h; Due 2/12)*
* [2.7. Pattern: Nested Iteration](../assignments/unit_2/readme.md#27-pattern-nested-iteration) *(3h; Due 2/17)*
* [2.8. Clock](../assignments/unit_2/readme.md#28-computational-clocks) *(5h; Due 2/24)*

---

### Some Helpful Videos 

*If you're struggling with any of the concepts from today's presentation, please check out the tutorial videos we've selected below — created by highly regarded, clear and patient educators:*

#### p5.js Graphics Primitives
