...
* Here is [an interactive video introduction to p5.js](http://hello.p5js.org/)
...
* Zach Lieberman [interviewed by Verse](https://twitter.com/verse_works/status/1688889255995609088), 2023. (4.5 minutes)

### Some exemplary recent works of poetic computing

Unlike large Pixar or TeamLab productions with hundreds of credits, nearly all of these projects were created by just one or two individuals. This is often made possible (in part) by leveraging the strengths of open-source software toolkits for the arts. 
